...
On the other hand, I **felt** 3.4.6 is a safer choice. I wouldn't want to run into potential issues because the IgH Master driver is untested on, say, 3.4.67 and so I went with the base version (3.4.6).  
