...
___
**Note:** In case you needed to reinstall the package (or install another version), delete "ethercat" and "ethercat-1.5.2" in /usr/local/src and "etherlab" in /opt. Then follow the installation guide up to (and including) the "depmod" step. 
___
